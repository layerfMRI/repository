...
Nordic_remove_noise.sh moco_Basis_bold.nii.gz 
cp NoNoise_moco_Basis_bold.nii.gz moco_Basis_bold.nii.gz 

Nordic_remove_noise.sh moco_Basis_cbv.nii.gz 
cp NoNoise_moco_Basis_cbv.nii.gz moco_Basis_cbv.nii.gz 
