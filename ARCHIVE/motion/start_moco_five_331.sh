...
cp /Users/huberl/NeuroDebian/repository/motion/five_emily_mocobatch2run.m ./five_emily_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "five_emily_mocobatch2run"
