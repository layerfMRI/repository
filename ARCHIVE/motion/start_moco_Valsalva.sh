...
cp /Users/huberl/NeuroDebian/repository/motion/Valsalva_batch2run.m ./Valsalva_batch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "Valsalva_batch2run"
