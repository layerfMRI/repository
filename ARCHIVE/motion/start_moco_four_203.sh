...
cp /Users/huberl/NeuroDebian/repository/motion/four_tot_mocobatch2run.m ./four_tot_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "four_tot_mocobatch2run"
