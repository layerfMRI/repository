...
cp /Users/huberl/NeuroDebian/repository/motion/six_eli_mocobatch2run.m ./six_eli_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "six_eli_mocobatch2run"
