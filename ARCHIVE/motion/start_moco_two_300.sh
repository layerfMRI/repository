...
cp /Users/huberl/NeuroDebian/repository/motion/two_threehundred_mocobatch2run.m ./two_threehundred_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "two_threehundred_mocobatch2run"
