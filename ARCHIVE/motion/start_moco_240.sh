...
cp /Users/huberl/NeuroDebian/repository/motion/twofour_mocobatch2run.m ./twofour_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "twofour_mocobatch2run"
