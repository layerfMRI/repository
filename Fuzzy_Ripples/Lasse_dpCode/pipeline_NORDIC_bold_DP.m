...
%% Sort DICOMS, convert, remove dummies, and split DP timeseries into separete
%Use sortDICOMS.sh
...
ARG.magnitude_only = 0; %only use magnitude images.
...
NIFTI_NORDIC_git(['noNORDIC_bold_0' num2str(run) '_dp1.nii'],['noNORDIC_bold_0' num2str(run) 'phase_dp1.nii'],['NORDIC_bold_0' num2str(run) '_dp1'],ARG);
NIFTI_NORDIC_git(['noNORDIC_bold_0' num2str(run) '_dp2.nii'],['noNORDIC_bold_0' num2str(run) 'phase_dp2.nii'],['NORDIC_bold_0' num2str(run) '_dp2'],ARG);
