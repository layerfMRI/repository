...
for filename in ./NORDIC_*_cbv*.nii
do
echo $filename
...
3dMean -prefix n_reference.nii Basis_cbv_${cnt}.nii'[3..5]'
...
for filename in ./NORDIC*_bold*.nii
do
echo $filename
...
3dMean -prefix nn_reference.nii Basis_bold_${cnt}.nii'[3..5]'
