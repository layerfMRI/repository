...
--shrink-factors 12x8x4x2  \
--smoothing-sigmas 4x3x2x1vox  \
--transform Affine[0.1] --metric MI[ref.nii,s3.nii,1,32,Regular,0.25]  \
--convergence [1000x500x250x100,1e-6,10]  \
--shrink-factors 12x8x4x2  \
--smoothing-sigmas 4x3x2x1vox  \
--transform SyN[0.1,3,0]  \
...
3dMean -prefix MP2RAGE_0.5.nii ref.nii registered3_Warped.nii.gz registered1_Warped.nii.gz -overwrite
