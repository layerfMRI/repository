...
void usage() { cout << "Write 1d file in mask <Bild 1 >   <mask> <cutoff> " << endl;}
...
//fürs Histogramm
    ...
    ofstream outtime("1D_time_course.dat");
  if (!outtime) {
...
//nrep = 60 ; // only while debugging.

cout << "nrep = " << nrep << endl; 

int numb_layers = 1; // This is the maximal number of layers. I don't know how to allocate it dynamically.
...
cout << " there are  " <<  numb_layers  << "  masks " <<  endl; 
...
//cout << "Debug: not segm foutl until here " <<  endl; 
int ingnore = 0;
