...
for file in *.nii.gz ; do mv $file ${file//_S00/_TI1} ; done
for file in *.json ; do mv $file ${file//_S00/_TI1} ; done

for file in *.nii.gz ; do mv $file ${file//_S01/_TI2} ; done
for file in *.json ; do mv $file ${file//_S01/_TI2} ; done
