...
cp /Users/huberl/NeuroDebian/repository/motion/Sean_mocobatch2run.m ./Sean_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "Sean_mocobatch2run"
