...
cp /Users/huberl/NeuroDebian/repository/motion/double_ninothree_mocobatch2run.m ./double_ninothree_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "double_ninothree_mocobatch2run"
