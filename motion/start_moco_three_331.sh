...
cp /Users/huberl/NeuroDebian/repository/motion/three_threethreeo_mocobatch2run.m ./three_threethreeo_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "three_threethreeo_mocobatch2run"
