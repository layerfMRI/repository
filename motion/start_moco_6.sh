...
cp /Users/huberl/NeuroDebian/repository/motion/six_min_mocobatch2run.m ./six_min_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "six_min_mocobatch2run"
