...
cp /Users/huberl/NeuroDebian/repository/motion/fifty_mocobatch2run.m ./fifty_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "fifty_mocobatch2run"
