...
cp /Users/huberl/NeuroDebian/repository/motion/twofortyV_mocobatch2run.m ./twofortyV_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "twofortyV_mocobatch2run"
