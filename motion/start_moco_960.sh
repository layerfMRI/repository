...
cp /Users/huberl/NeuroDebian/repository/motion/ninesix_mocobatch2run.m ./ninesix_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "ninesix_mocobatch2run"
