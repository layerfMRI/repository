...
cp /Users/huberl/NeuroDebian/repository/motion/htw_mocobatch2run.m ./htw_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "htw_mocobatch2run"
