...
cp /Users/huberl/NeuroDebian/repository/motion/two_nineOthree_mocobatch2run.m ./two_nineOthree_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "two_nineOthree_mocobatch2run"
