...
cp /Users/huberl/NeuroDebian/repository/motion/four_emily_mocobatch2run.m ./four_emily_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "four_emily_mocobatch2run"
