...
cp /Users/huberl/NeuroDebian/repository/motion/three_twenty_mocobatch2run.m ./three_twenty_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "three_twenty_mocobatch2run"
