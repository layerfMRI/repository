...
cp ./AMPL5.nii ./Basis_5a.nii
cp ./AMPL5.nii ./Basis_5b.nii
...
cp /Users/huberl/NeuroDebian/repository/motion/six_emily_mocobatch2run.m ./six_emily_mocobatch2run.m
/Applications/MATLAB_R2016a.app/bin/matlab -nodesktop -nosplash -r "six_emily_mocobatch2run"
