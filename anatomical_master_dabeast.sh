...
#on felix run me with: sbatch --mem=8g --cpus-per-task=8 --time=48:00:00  anatomical_master.sh
...
export export FREESURFER_HOME=/mnt/4TB_pcie/SriKashyap/Freesurfer/freesurfer/
source /mnt/4TB_pcie/SriKashyap/Freesurfer/freesurfer/SetUpFreeSurfer.sh
